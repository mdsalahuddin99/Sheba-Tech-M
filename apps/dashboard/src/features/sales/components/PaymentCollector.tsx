...
export function PaymentCollector({
  ...
  return (
    <Collapsible defaultOpen className="rounded-[2px] border border-border bg-card overflow-hidden">
      {/* Header */}
      <CollapsibleTrigger className="flex w-full items-center justify-between px-2 py-1.5 hover:bg-secondary/40 transition-colors">
        ...
        <div className="px-2 py-2 space-y-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="space-y-0.5">
              ...
              <div className="h-6 flex items-center px-2 rounded-[2px] bg-secondary/40 border border-border text-[11px] font-semibold text-slate-700 tabular-nums">
            ...
            <div className="space-y-0.5">
              ...
              <div className="h-6 flex items-center justify-end px-2 rounded-[2px] bg-primary/10 border border-primary/20 text-[11px] font-bold text-primary tabular-nums">
              ...
              <div className="space-y-1">
                {payments.map((p, i) => {
                  ...
                  return (
                    <div
                      key={`${p.method}-${i}`}
                      className="flex items-center justify-between p-1.5 bg-secondary/35 border border-border rounded-[2px]"
                    >
                      ...
                      <div className="flex items-center gap-1.5">
                        ...
                        <div className="flex items-center gap-0.5 border-l border-border pl-1 ml-0.5">
                          <button
                            ...
                            className="h-5 w-5 rounded-[2px] grid place-items-center text-slate-400 hover:text-primary hover:bg-secondary transition-colors"
                            title="Edit"
                          >
                          ...
                          <button
                            ...
                            className="h-5 w-5 rounded-[2px] grid place-items-center text-slate-400 hover:text-destructive hover:bg-red-50 transition-colors"
                            title="Delete"
                          >
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div className="space-y-0.5">
                  ...
                  >
                    <SelectTrigger className="h-7 border-border bg-card text-[11px] rounded-[2px]">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                ...
                <div className="space-y-0.5">
                  ...
                  {pendingMethod === "Wallet" ? (
                    <Select disabled value="wallet-na">
                      <SelectTrigger className="h-7 border-border bg-secondary/35 text-slate-400 text-[11px] rounded-[2px]">
              ...
              <div className="flex gap-2">
                <div className="flex-1 space-y-0.5">
                  ...
                  <Input
                    ...
                    className="h-7 text-right border-border bg-card text-[11px] rounded-[2px]"
                ...
                <div className="space-y-0.5">
                  ...
                  <Button
                    type="button"
                    size="sm"
                    className="h-7 bg-primary hover:bg-primary/95 text-white px-3 rounded-[2px] font-bold text-[11px]"
