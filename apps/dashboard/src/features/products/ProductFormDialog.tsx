  ...
  useEffect(() => {
    ...
    if (editing) {
      ...
      form.reset({
        ...
        category: (rest as any).categoryId ?? "",
        subcategory: rest.subcategory ?? "",
        series: (rest as any).globalSeriesId ?? "",
        brand: (rest as any).globalBrandId ?? "",
        model: (rest as any).globalModelId ?? "",
        price: (rest.price ?? defaults.price) as unknown as number,
        costPrice: ((rest as any).cost ?? defaults.costPrice) as unknown as number,
        ...
        minStock: (rest as any).reorderLevel ?? defaults.minStock,
        unit: rest.unit ?? defaults.unit,
        active: (rest as any).isPublished ?? defaults.active,
        ...
        serialNumber: (rest as any).serialNumber ?? "",
        imei: (rest as any).imei ?? "",
        type: (rest as any).productTypeId ?? "simple",
